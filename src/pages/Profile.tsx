...
export default function Profile() {
  ...
  return (
    <div className="container mx-auto px-10 py-24 min-h-screen bg-[#F8F4F1]">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between border-b border-[#E8DDD7] pb-12">
          ...
          <div className="flex gap-4">
               <Button variant="outline" className="rounded-2xl h-14 border-[#E8DDD7] bg-white text-[10px] font-black uppercase tracking-widest gap-2">
